%% AC imaging
clear; 
tiffPath = 'D:\labData\2pData_meso\zz131\050823\FOV2';
fileName = 'zz131_050823_fov2_pt_00001_00001.tif';
roiSize = [512 300]; nROI = 4; roiPos = [3 1 2 4];  tempFrame = [2 2 200];
...
for i = 1:nTrials
    tempFrameStart = (i-1)*nFramesPerTrial+1; 
...
for i = 1:17
    ...
    imagesc(tempImg'); colormap gray; clim([-30 30]);
