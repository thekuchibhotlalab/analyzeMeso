clear;
imgRaw = double(tiffreadVolume('AC_PPC\AC_PPC_sound_011723_00002.tif'));
%%
img = imgRaw(:,:,1:2:end);
%%clear
...
xlen = 1024; ylen = 512*2; 
roiPos = {[1 512;1 512],[1 512;513 1024],[513 1024;1 512],[513 1024;513 1024]};
...
soundEvokedFOV = (soundEvokedFOV - baselineEvokedFOV)./baselineEvokedFOV; 
%%
K = (1/1600)*ones(40);
