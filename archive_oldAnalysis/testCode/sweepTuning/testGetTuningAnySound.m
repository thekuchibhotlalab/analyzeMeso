function testGetTuningAnySound(TCpretone_reorder)
savePath = 'C:\Users\zzhu34\Documents\tempdata\ab01\FM_14x\suite2p\plane0\sweepTuning';
nNeuron = size(TCpretone_reorder,4);
nTones = size(TCpretone_reorder,2);
nTrials = size(TCpretone_reorder,3);
nFramesPerTone = size(TCpretone_reorder,1); % 50
