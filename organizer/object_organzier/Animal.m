classdef Animal
    ...
    methods
        function obj = Animal(id,varargin)
            ...
            addParameter(p, 'sessionInfoDir', '');
            addParameter(p, 'actType', 'spk');
            addParameter(p, 'parseTrial', false);
            ...
            if ~isempty(p.Results.sessionInfoDir)
                obj.ops.sessionInfoDir = p.Results.sessionInfoDir;
                load(p.Results.sessionInfoDir,'sessionInfo','alignmentOps');
