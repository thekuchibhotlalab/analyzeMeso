function [outDff,selected_flags,selected_counts,new_means] = fn_matchRT(trialTypeInfo,dffType)
    ...
    for i = 1:length(trialTypeInfo.behSelTrialType)
        ...
        outDff(i,:) = cellfun((@(x)(x)),trialTypeInfo.(dffType){i},'UniformOutput',false);
    end
